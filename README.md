...
4. **Methods & validation**: why each analysis was done and what it showed, the independent reclustering, clustering stability, the raw-count doublet screen, and provisional annotations.
